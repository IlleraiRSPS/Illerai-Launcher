...
cp native/build-aarch64/src/Release/Illerai.exe build/win-aarch64/
cp target/Illerai.jar build/win-aarch64/
...
sha256sum build/win-aarch64/Illerai.exe

dumpbin //HEADERS build/win-aarch64/Illerai.exe
