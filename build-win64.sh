...
cp native/build-x64/src/Release/Illerai.exe build/win-x64/
cp target/Illerai.jar build/win-x64/
...
sha256sum build/win-x64/Illerai.exe

dumpbin //HEADERS build/win-x64/Illerai.exe
